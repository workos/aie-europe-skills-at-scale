...
<img src="/section-build-pixel.png" class="absolute inset-0 w-full h-full object-cover opacity-10" />
...
<img src="/section-beyond-pixel.png" class="absolute inset-0 w-full h-full object-cover opacity-10" />
...
<div class="text-sm font-semibold mb-2 text-gray-500">Prompt: "Animate a Slack avatar image"</div>
...
<div class="flex flex-col items-center">
<div class="text-sm font-semibold mb-2 text-gray-500">Prompt: "Girl running through field"</div>
...
Minimal prompts, full animations — generated by a single 30-line skill you can drop into any video
